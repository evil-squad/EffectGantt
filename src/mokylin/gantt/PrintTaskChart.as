package mokylin.gantt
{
    ...
    public class PrintTaskChart extends TaskChart 
    {
        ...
        public function initializeFrom(value:TaskChart):void
        {
            ...
            taskIdField = value.taskIdField;
            taskIdFunction = value.taskIdFunction;
            taskIsMilestoneField = value.taskIsMilestoneField;
            taskIsMilestoneFunction = value.taskIsMilestoneFunction;
            taskIsSummaryField = value.taskIsSummaryField;
            taskIsSummaryFunction = value.taskIsSummaryFunction;
            taskLabelField = value.taskLabelField;
            taskLabelFunction = value.taskLabelFunction;
            constraintDataProvider = value.constraintDataProvider;
            constraintFromIdField = value.constraintFromIdField;
            constraintFromIdFunction = value.constraintFromIdFunction;
            constraintToIdField = value.constraintToIdField;
            constraintToIdFunction = value.constraintToIdFunction;
            constraintKindField = value.constraintKindField;
            constraintKindFunction = value.constraintKindFunction;
